...
export default function Form() {
    ...
    const [chosenQuest, setChosenQuest] = useState(0)
        ...
        <ThemeProvider theme={theme}>
            <Container showsVerticalScrollIndicator={false}>
                ...
                <Questoes>
                    ...
                    <Imagemteste source={{uri: questoes[chosenQuest].imagem}} resizeMode="contain" style={{height: 450, width: 450, marginLeft:270}}/>
        ...
        return(<TextoInformativo>Ops... parece que não há questões cadastradas ainda</TextoInformativo>)
    }
} 
...
const Botao = styled(Pressable)<Alternativa>`   
    ...
    type === 'PRIMARY' ? theme.COLORS.GRAY_100 : theme.COLORS.WHITE};
`
...
const TextoInformativo = styled.Text`
    margin-top: 250px;
    margin-left: 550px;
    font-size: 20px;
