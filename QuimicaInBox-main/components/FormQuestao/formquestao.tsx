...
export default function FormQuestao(){
    ...
    async function addnewquestion() {
        ...
        if (!altA.trim() || !altB.trim() || !altC.trim() || !altD.trim() || !altE.trim()) {
        ...
        if (selectedArea === 0 || selectedSubarea === 0 || selectedNivel === 0) {
            alert("Por favor, selecione a área, subárea e nível.");
            return;
        }
